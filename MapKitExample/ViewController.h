...
/*
 ...
 7) Добавил фишку: теперь можно утсанавливать маркер на любую координату;
 8) Добавил фишку: по нажатию на кнопку можно перейти на какую-то заданную заранее координату
*/